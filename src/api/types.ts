...
export interface paths {
  ...
  "/me/voyage/seances/{id}/remplacer": {
     ...
     *
     * Pour `morceau: "long"` : `film_id` doit être un long (sans programme), non vu, non introuvable, et `bobine_tmdb_id` doit être absent — sinon `400 VALIDATION`. Pour `morceau: "court"` : `film_id` est un film sans programme (non vu, non introuvable, sans `bobine_tmdb_id`) ou un programme ; pour un programme, sans `bobine_tmdb_id`, le programme entier doit n’être ni entièrement vu ni introuvable ; avec, `bobine_tmdb_id` doit appartenir à ce programme et n’être ni vu ni introuvable — sinon `400 VALIDATION`.
     *
